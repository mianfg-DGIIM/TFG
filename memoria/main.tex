...
\setpartpreamble[c][0.75\linewidth]{%
	\bigskip % Deja un espacio vertical en la parte superior
  Introduciremos una formalización matemática de los conceptos de \emph{verdad} y \emph{demostración}, y estudiaremos las propiedades de los sistemas en los que están definidos, para hablar finalmente de la aritmética de Peano. A partir de la decidibilidad del problema de parada, probaremos que la aritmética de Peano es incompleta, bajo unas ciertas condiciones. Generalizaremos este resultado para obtener dos versiones del Primer Teorema de Incompletitud. Finalmente, compararemos estas dos versiones junto con la versión original de Gödel y analizaremos importantes consecuencias de estos resultados.
}
...
\setpartpreamble[c][0.75\linewidth]{%
	\bigskip % Deja un espacio vertical en la parte superior
  Concluiremos el trabajo revisando los objetivos iniciales y asentando las posibles vías de investigación y desarrollo en un futuro
}
\cleardoublepage\part{Conclusiones}\label{part:conclusion}

...
% Trabajo de Fin de Grado: Una perspectiva algorímtica a la incompletitud de las Matemáticas
...
\usepackage{newfloat}
%\DeclareCaptionType[fileext=ext, listname={Lista de problemas}, name=Problema, placement=tbph!]{problema}
%\captionsetup[scheme]{labelsep=period, font={small, bf}, skip=8pt}
%\newfloat{problema}{H}{flt}[chapter]
%\floatname{problema}{Problema}
\DeclareFloatingEnvironment[listname={Índice de problemas},placement=H]{problema}

%\newfloat{tabla}{H}{flt}[chapter]
...
\newcommand{\miBorrador}{BORRADOR FINAL}
\newcommand{\miTitulo}{Una perspectiva algorítmica a la incompletitud de las Matemáticas\xspace}
\newcommand{\miNombre}{Miguel Ángel Fernández Gutiérrez\xspace}
\newcommand{\miGrado}{Doble Grado en \\ Ingeniería Informática y Matemáticas}
\newcommand{\miFacultad}{Escuela Técnica Superior de \\ Ingenierías Informática y de Telecomunicación \\[4pt] Facultad de Ciencias}
\newcommand{\miFacultadNoSpace}{Escuela Técnica Superior de Ingenierías Informática y de Telecomunicación \\[4pt] Facultad de Ciencias}
\newcommand{\miUniversidad}{Universidad de Granada}
% Añadir tantos tutores como sea necesario separando cada uno de ellos
% mediante el comando `\medskip` y una línea en blanco
\newcommand{\miTutor}{
  Serafín Moral Callejón \\ \emph{Departamento de Ciencias de la Computación e Inteligencia Artificial}
}
...
\usepackage[firstpageonly=true, angle=58]{draftwatermark}
\SetWatermarkText{\sffamily \miBorrador}
...
\hypersetup{
 ...
 pdfsubject={Trabajo de Fin de Grado — \miGrado — Curso \miCurso},
 pdfkeywords={incompletitud, informática, matemáticas, TFG},
 pdfproducer=mianfg,
 pdfcreator=pdflatex,
 breaklinks=true
}
...
\setpartpreamble[c][0.75\linewidth]{%
  ...
  Hablaremos de la motivación que subyace en este trabajo, concretando los objetivos que se pretenden conseguir. A continuación, daremos una contextualización histórica de los temas tratados.
}
\part{Introducción}\label{part:introduccion} % Dividir un libro en partes OPCIONAL

\input{capitulos/parte01/capitulo01}
\input{capitulos/parte01/capitulo02}
...
\cleardoublepage\part{Fundamentos}
\input{capitulos/parte02/capitulo01}
\input{capitulos/parte02/capitulo02}
...
\cleardoublepage\part{Incompletitud}
\input{capitulos/parte03/capitulo01}
\input{capitulos/parte03/capitulo02}
%\input{capitulos/parte03/capitulo03}
%\input{capitulos/parte03/capitulo04}

\setpartpreamble[c][0.75\linewidth]{%
	\bigskip % Deja un espacio vertical en la parte superior
  Concluimos el trabajo revisando los objetivos iniciales y asentando las posibles vías de investigación y desarrollo en un futuro
}
\cleardoublepage\part{Conclusión}\label{part:conclusion}
\input{capitulos/parte04/capitulo01}
\input{capitulos/parte04/capitulo02}
...
%\cleardoublepage\part{Referencias e Índices}
...
%\setbibpreamble{References are listed in alphabetical order, by author. The references with more than one author are ordered according to the first author.\par\bigskip}
...
%\printbibliography[heading=subbibliography,title={Bibliografía básica},segment=1]
...
%\pdfbookmark[-1]{Bibliografía}{Bibliografia}
...
%\cleardoublepage
%\phantomsection
%\listoftheorems[ignoreall,show={definicion},title={Índice de definiciones}]
